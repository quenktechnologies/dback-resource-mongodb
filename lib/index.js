    ...
    constructor() {
        this.create = (_) => {
            ...
            return api_1.doAction(function* () {
                ...
                let data = yield prs.getOrElse("resource.mongodb.create.data" /* data */, {});
                let id = yield exports.runCreate(model, data);
        ...
        this.update = (r) => {
            ...
            return api_1.doAction(function* () {
                let model = yield that.getModel();
                let data = yield prs.getOrElse("resource.mongodb.update.data" /* data */, {});
                let yes = yield exports.runUpdate(model, r.params.id, data);
