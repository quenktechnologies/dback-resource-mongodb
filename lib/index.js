    ...
    constructor() {
        this.create = (r) => {
            ...
            return api_1.doAction(function* () {
                ...
                let id = yield exports.runCreate(model, r2.body);
        ...
        this.update = (r) => {
            ...
            return api_1.doAction(function* () {
                ...
                if (r2 == null)
                    return control_1.noop();
                let model = yield that.getModel();
                let yes = yield exports.runUpdate(model, r2.params.id, r2.body);
        ...
        this.get = (r) => {
            ...
            return api_1.doAction(function* () {
                ...
                if (r2 == null)
                    return control_1.noop();
                let model = yield that.getModel();
                let mdoc = yield exports.runGet(model, r2.params.id);
        ...
        this.remove = (r) => {
            ...
            return api_1.doAction(function* () {
                ...
                if (r2 == null)
                    return control_1.noop();
                let model = yield that.getModel();
                let yes = yield exports.runRemove(model, r2.params.id);
                return yes ? response_1.ok() : response_2.notFound();
            });
        };
    }
